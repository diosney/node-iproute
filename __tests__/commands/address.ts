...
import { Tests as addressShowdumpTests } from './fixtures/address-showdump';
...
describe('address', function () {
  ...
  describe('showdump', function () {
    addressShowdumpTests.forEach((test) => {
      describe(test.description, function () {
        it('should build the proper cmd array & string', async function () {
          let ipCommand = await showdump(test.options,
            Object.assign({}, test.globalOptions,
              {
                dryRun: true
              })) as any;
