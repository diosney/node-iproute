  ...
  describe('when testing a command with all parameter types', function () {
    it('should build the proper cmd string', async function () {
      ...
      expect(ipCommand.cmdToExec)
        .to.be.a('string')
        .and.to.be.eq(
        ' test a_string a-string a_number 1 a_tuple 0 1 a_flag noa_flag an_enum value-a a_string b-string a_number 2 a_tuple 2 3 noa_flag a_flag an_enum value-b');
    });
  });
});