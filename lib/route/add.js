...
module.exports = function (options, cb) {
  ...
  if (typeof options.quickack != 'undefined') {
    if (options.quickack == true
      || options.quickack == 1
      || options.quickack == '1') {

      args = args.concat('quickack', 1);
    }
    else {
      args = args.concat('quickack', 0);
    }
  }
